...
/**
    * РЎРєСЂРёРїС‚ РґР»СЏ Р·Р°РїРѕР»РЅРµРЅРёСЏ Р±Р°Р·С‹ РґР°РЅРЅС‹С… Р±СЂРѕРЅРёСЂРѕРІР°РЅРёР№ СЂРµР°Р»РёСЃС‚РёС‡РЅС‹РјРё РґР°РЅРЅС‹РјРё
    * Р—Р°РїСѓСЃРєР°РµС‚СЃСЏ РѕРґРёРЅ СЂР°Р· РґР»СЏ РёРЅРёС†РёР°Р»РёР·Р°С†РёРё Р±Р°Р·С‹ РґР°РЅРЅС‹С…
    * РЎРѕР·РґР°РµС‚ 25 Р±СЂРѕРЅРёСЂРѕРІР°РЅРёР№ СЃ СЂР°Р·РЅС‹РјРё СЃС‚Р°С‚СѓСЃР°РјРё Рё РґРµС‚Р°Р»СЏРјРё
    * Р’С‹РІРѕРґРёС‚ СЃС‚Р°С‚РёСЃС‚РёРєСѓ РїРѕ СЃРѕР·РґР°РЅРЅС‹Рј Р±СЂРѕРЅРёСЂРѕРІР°РЅРёСЏРј
 */

// Р РµР°Р»РёСЃС‚РёС‡РЅС‹Рµ РґР°РЅРЅС‹Рµ
const roomTypes = [
...
async function seedBookings() {
  try {
    ...
    if (existingBookings >= 20) {
      console.log('вљ пёЏ  Database already contains 20+ bookings. Skipping seed.');
      console.log(`Found ${existingBookings} booking(s).`);
      process.exit(0);
    }

    console.log('рџЏЁ Generating 25 realistic hotel bookings...\n');
    ...
    console.log(`вњ… Successfully inserted ${result.insertedCount} bookings!\n`);
    ...
    console.log('рџ“Љ Booking Statistics:');
    ...
    console.error('вќЊ Error seeding bookings:', error);
    process.exit(1);
  }
}
